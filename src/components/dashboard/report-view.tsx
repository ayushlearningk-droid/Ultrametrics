...
export function ReportView({
  ...
  return (
    <div className="report-print mx-auto max-w-3xl space-y-8 px-4 py-8 md:px-6">
      {/* Print/PDF-only branding band (hidden on screen). */}
      <div className="report-brand hidden print:block">
        Ultra<span>metrics</span>
      </div>
      ...
      <footer className="report-footer report-section flex flex-wrap items-center justify-between gap-2 border-t border-white/[0.08] pt-4 type-caption text-foreground-muted">
        <span>Generated by Ultrametrics</span>
        <span>
          {workspaceName} · {data.dateLabel}
        </span>
      </footer>
